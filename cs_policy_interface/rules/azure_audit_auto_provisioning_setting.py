...
# This policy audits whether AutoProvisioning Monitoring is enabled.
...
class RuleExecutor(object):
    ...
    def execute(self, **kwargs):
        ...
        try:
            ...
            resource_url = AzureRestApiEndpoint.list_auto_provisioning_settings.format(endpoint, credentials['subscription_id'])
            ...
            for each_resource in get_response.json()['value']:
                ...
                if not each_resource.get('properties', {}).get('autoProvision', {}) == "On":

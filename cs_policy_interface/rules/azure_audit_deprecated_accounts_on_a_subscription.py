"""
This policy audits whether Deprecated accounts are in your subscriptions.
Deprecated accounts are accounts that
"""
    ...
    def execute(self, **kwargs):
        ...
        try:
            ...
            for each_resource in get_response.json()['value']:
                if each_resource.get('properties', {}).get('principalType') == 'User':

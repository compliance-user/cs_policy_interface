"""
This policy audits whether External Accounts with write permissions in a Subscription. If there are external
accounts with write permissions are found, then it should be reviewed with business purpose.
"""

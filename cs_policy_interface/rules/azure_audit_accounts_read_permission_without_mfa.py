"""
This policy audits whether Accounts with read permissions that are MFA Disabled in Subscription.  It should be
enabled for all subscription accounts with read privileges to prevent a breach of accounts or resources.
"""
